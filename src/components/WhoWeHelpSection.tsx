    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 lg:mb-20">
          <span className="text-[11px] sm:text-xs font-bold uppercase tracking-wider text-[#86EFAC] block mb-2 sm:mb-3">
              ...
              >
                ...
                {segment.imageUrl && (
                  <div className="relative w-full">
                    ...
                    <div className="relative h-32 sm:h-36 w-full overflow-hidden bg-black/40">
                      <img
                ...
                <div className="p-5 sm:p-6 pt-7 sm:pt-8 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-xs sm:text-sm text-slate-300 leading-relaxed min-h-[44px] sm:min-h-[48px]">
                      {segment.description}
                    </p>
                  </div>
                  ...
                  <div className="mt-5 sm:mt-6 pt-3.5 sm:pt-4 border-t border-white/10">
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-1.5">
                      {segment.focusAreas.map((tag) => (
                        <span
                          key={tag}
                          className="px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md bg-white/5 border border-white/10 text-[11px] sm:text-xs text-[#86EFAC] font-medium"
                        >
                          {tag}
                        </span>
                      ))}
