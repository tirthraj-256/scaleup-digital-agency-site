...
export const ContactSection: React.FC<ContactSectionProps> = ({ preselectedService }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-10 w-96 h-96 bg-[#22C55E]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#84CC16]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-[#0F2D23] border border-[#22C55E]/30 hover:border-[#22C55E] hover:bg-[#133A2E] transition-all group shadow-md shadow-black/20"
              >
                <div className="w-12 h-12 rounded-xl bg-[#22C55E]/20 text-[#22C55E] flex items-center justify-center group-hover:scale-105 transition-transform shrink-0">
                  <MessageSquare className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-xs uppercase font-bold tracking-wider text-[#86EFAC]">
                    Fastest Response &bull; WhatsApp
                  </span>
                  <p className="text-base font-bold text-white group-hover:text-[#22C55E] transition-colors">
                    +91 99099 92573
                  </p>
                  <span className="text-[11px] text-slate-400">Click to start direct WhatsApp chat</span>
                </div>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-[#0F2D23] border border-white/10 hover:border-[#86EFAC]/40 hover:bg-[#133A2E] transition-all group"
              >
                <div className="w-12 h-12 rounded-xl bg-white/5 text-[#86EFAC] flex items-center justify-center group-hover:scale-105 transition-transform shrink-0">
                ...
                <div>
                  ...
                  <p className="text-base font-bold text-white group-hover:text-[#86EFAC] transition-colors">
                    {AGENCY_INFO.phone}
                  </p>
                  <span className="text-[11px] text-slate-400">Monday &ndash; Saturday &bull; 9 AM to 7 PM IST</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-base font-bold text-white group-hover:text-[#86EFAC] transition-colors truncate">
                    {AGENCY_INFO.email}
                  </p>
                  <span className="text-[11px] text-slate-400">Detailed proposals &amp; RFP submissions</span>
                </div>
              </a>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className="relative rounded-2xl glass-card p-6 sm:p-9 border border-[#86EFAC]/20 shadow-2xl">
              {submitted ? (
                <div
                  id="form-success-state"
                  className="py-10 px-4 text-center flex flex-col items-center space-y-4 animate-in fade-in"
                >
                  <div className="w-16 h-16 rounded-2xl bg-[#22C55E]/20 border border-[#22C55E]/40 flex items-center justify-center text-[#22C55E] mb-1">
                  ...
                  <div className="w-full max-w-md p-4 rounded-xl bg-black/30 border border-[#22C55E]/30 text-left space-y-2 text-xs text-slate-300">
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row items-center gap-3 w-full max-w-md">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full inline-flex items-center justify-center gap-2 py-3.5 px-5 rounded-xl bg-[#22C55E] text-[#0F2D23] font-bold text-sm hover:bg-[#84CC16] transition-all shadow-md shadow-[#22C55E]/20"
                    >
                    ...
                    <button
                      onClick={handleReset}
                      className="w-full py-3.5 px-5 rounded-xl bg-white/10 text-white font-medium text-sm hover:bg-white/15 transition-all"
                    >
                ...
                <form id="contact-enquiry-form" onSubmit={handleSubmit} className="space-y-5">
                  <div className="border-b border-white/10 pb-4 mb-5">
                    <h3 className="text-xl font-bold text-white">Send Us An Enquiry</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-black/30 border border-white/15 focus:border-[#22C55E] text-white placeholder-slate-500 text-sm focus:outline-none transition-colors"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 rounded-xl bg-[#0F2D23] border border-white/15 focus:border-[#22C55E] text-white text-sm focus:outline-none transition-colors"
                    >
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center gap-2.5 py-4 px-6 rounded-xl font-bold text-base bg-[#22C55E] text-[#0F2D23] hover:bg-[#84CC16] disabled:opacity-75 transition-all duration-200 shadow-lg shadow-[#22C55E]/25 hover:shadow-xl hover:shadow-[#84CC16]/30"
                    >
                      {isSubmitting ? (
