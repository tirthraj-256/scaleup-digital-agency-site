...
export const WhyChooseUsSection: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-10 right-10 w-96 h-96 bg-[#22C55E]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-[#84CC16]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {WHY_US_ITEMS.map((item) => (
            <div
              ...
              className="relative rounded-2xl glass-card p-7 sm:p-8 border border-[#86EFAC]/15 hover:border-[#22C55E]/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#22C55E]/10 flex flex-col justify-between group"
            >
              <div>
                {/* Number & Tag */}
                <div className="flex items-center justify-between mb-6">
                  ...
                  <span className="text-[11px] font-semibold text-[#86EFAC]/90 uppercase tracking-wider px-2.5 py-1 rounded-full bg-white/5 border border-white/10">
                    {item.tag}
                  </span>
                </div>
