...
export const AboutSection: React.FC<AboutSectionProps> = ({ onNavigate }) => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 bg-[#22C55E]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-10 w-80 h-80 bg-[#84CC16]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 order-2 lg:order-1">
            <div className="relative">
              {/* Outer glowing frame */}
              <div className="absolute -inset-2 bg-gradient-to-r from-[#22C55E]/30 to-[#84CC16]/20 rounded-3xl blur-xl opacity-60 pointer-events-none" />
              ...
              <div className="relative rounded-2xl overflow-hidden border border-[#86EFAC]/25 bg-[#091C16] shadow-2xl">
                ...
                <div className="relative h-64 sm:h-72 w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-6 right-6 z-10 flex items-center justify-between">
                    <div>
                      ...
                      <h4 className="text-lg sm:text-xl font-bold text-white mt-0.5 drop-shadow-md">
                        Synergy of Strategy &amp; Execution
                      </h4>
                    </div>
                    <div className="w-10 h-10 rounded-xl bg-[#22C55E] text-[#0F2D23] flex items-center justify-center shadow-lg shadow-[#22C55E]/30 shrink-0">
                ...
                <div className="p-6 sm:p-7 pt-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 mb-5">
                    ...
                    <div className="p-3.5 rounded-xl bg-black/35 border border-white/10 hover:border-[#22C55E]/40 transition-all">
                      <div className="w-8 h-8 rounded-lg bg-[#22C55E]/15 text-[#22C55E] flex items-center justify-center mb-2">
                        <Compass className="w-4 h-4" />
                      </div>
                      <h5 className="text-sm font-bold text-white">Marketing Strategy</h5>
                    ...
                    <div className="p-3.5 rounded-xl bg-black/35 border border-white/10 hover:border-[#84CC16]/40 transition-all">
                      <div className="w-8 h-8 rounded-lg bg-[#84CC16]/15 text-[#84CC16] flex items-center justify-center mb-2">
                        <LineChart className="w-4 h-4" />
                      </div>
                      <h5 className="text-sm font-bold text-white">Analytics &amp; Data</h5>
                      <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                    ...
                    <div className="p-3.5 rounded-xl bg-black/35 border border-white/10 hover:border-[#86EFAC]/40 transition-all">
                      <div className="w-8 h-8 rounded-lg bg-[#86EFAC]/15 text-[#86EFAC] flex items-center justify-center mb-2">
                        <Users2 className="w-4 h-4" />
                      </div>
                      <h5 className="text-sm font-bold text-white">Team Collaboration</h5>
                      <p className="text-xs text-slate-400 mt-1 leading-relaxed">
                    ...
                    <div className="p-3.5 rounded-xl bg-black/35 border border-white/10 hover:border-[#22C55E]/40 transition-all">
                      ...
                      <h5 className="text-sm font-bold text-white">Business Scaling</h5>
                      <p className="text-xs text-slate-400 mt-1 leading-relaxed">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 flex flex-col space-y-6 text-left">
            <div>
              <span className="inline-block text-xs sm:text-sm font-bold uppercase tracking-wider text-[#86EFAC] mb-3">
                About Scaleup
              </span>
              <h2
                id="about-heading"
            ...
            <div className="pt-4">
              <button
                ...
                id="about-cta-button"
                className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-xl text-base font-bold bg-[#22C55E] text-[#0F2D23] hover:bg-[#84CC16] transition-all duration-200 shadow-md shadow-[#22C55E]/20 hover:shadow-xl hover:shadow-[#84CC16]/30 hover:-translate-y-0.5"
              >
