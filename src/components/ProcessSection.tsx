...
export const ProcessSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[500px] bg-[#22C55E]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="hidden lg:block relative">
          ...
          <div className="absolute top-[38px] left-[10%] right-[10%] h-[3px] bg-gradient-to-r from-[#22C55E]/20 via-[#22C55E] to-[#84CC16]/30 -z-0">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative mb-6">
                    <div className="w-18 h-18 rounded-2xl bg-[#0F2D23] border-2 border-[#22C55E]/50 group-hover:border-[#84CC16] p-2 flex items-center justify-center shadow-lg shadow-[#22C55E]/15 group-hover:scale-110 transition-all duration-300">
                      <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#22C55E]/20 to-[#84CC16]/20 flex items-center justify-center text-[#22C55E] group-hover:text-white transition-colors">
                        <Icon className="w-6 h-6 stroke-[2.2]" />
                      </div>
                    </div>
                    <span className="absolute -top-2 -right-2 px-2 py-0.5 rounded-md bg-[#22C55E] text-[#0F2D23] text-[11px] font-black tracking-wider">
                      {step.step}
                    </span>
                  </div>

                  {/* Step Content Card */}
                  <div className="w-full p-4 rounded-xl bg-[#0F2D23]/60 border border-white/10 group-hover:border-[#22C55E]/30 transition-all flex flex-col justify-between min-h-[160px]">
                    <div>
        ...
        <div className="lg:hidden relative pl-6 sm:pl-8 space-y-8">
          ...
          <div className="absolute top-4 bottom-4 left-6 sm:left-8 -translate-x-1/2 w-[3px] bg-gradient-to-b from-[#22C55E] via-[#86EFAC] to-[#84CC16]/30" />
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 -ml-6 sm:-ml-8 shrink-0">
                  <div className="w-12 h-12 rounded-xl bg-[#0F2D23] border-2 border-[#22C55E] flex items-center justify-center shadow-md shadow-[#22C55E]/20 text-[#22C55E]">
                    <Icon className="w-5 h-5" />
                  </div>
                </div>

                {/* Content Card */}
                <div className="flex-1 p-5 rounded-xl bg-[#0F2D23]/80 border border-white/10">
