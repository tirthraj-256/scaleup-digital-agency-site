...
export const ServicesSection: React.FC<ServicesSectionProps> = ({
  ...
  return (
    <section
      id="services"
      className="relative py-16 sm:py-20 lg:py-32 bg-[#091C16] border-t border-white/5"
    >
      {/* Background glow effects */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[350px] sm:w-[600px] lg:w-[900px] h-[300px] sm:h-[500px] bg-[#22C55E]/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16 lg:mb-20">
          ...
          <p
            ...
            className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg text-slate-300 max-w-2xl mx-auto font-normal leading-relaxed"
          >
          ...
          {SERVICES.map((service) => {
            ...
            return (
              ...
              >
                  ...
                  <div className="relative w-full">
                    ...
                    <div className="relative h-36 sm:h-40 w-full overflow-hidden bg-black/40">
                      ...
                      <div className="absolute top-2.5 right-2.5 sm:top-3 sm:right-3 z-10">
                        <span className="text-[10px] sm:text-[11px] font-semibold text-white px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-md bg-black/65 backdrop-blur-md border border-white/20 shadow-sm">
                          {service.badge}
                        </span>
                      </div>
                    </div>
                    ...
                    {/* Floating Icon */}
                    <div className="absolute -bottom-4 sm:-bottom-5 left-4 sm:left-5 z-20 w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-[#0F2D23] border border-[#22C55E]/40 p-0.5 shadow-lg shadow-black/50">
                ...
                <div className="p-5 sm:p-6 pt-7 sm:pt-8 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="mt-2 sm:mt-2.5 text-xs sm:text-sm text-slate-300 leading-relaxed min-h-[50px] sm:min-h-[58px]">
                      {service.shortDescription}
                    </p>

                    {/* Deliverables Bullet List */}
                    <div className="mt-3.5 sm:mt-4 pt-3 sm:pt-3.5 border-t border-white/10">
                      <span className="text-[10px] sm:text-[11px] uppercase font-bold tracking-wider text-slate-400 block mb-2">
                  ...
                  <div className="mt-5 sm:mt-6 pt-3.5 sm:pt-4 border-t border-white/10 flex items-center justify-between">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-[#86EFAC] hover:text-[#84CC16] transition-colors group-hover:translate-x-0.5 duration-200 cursor-pointer py-1"
                    >
                    ...
                    <button
                      ...
                      className="text-[11px] font-semibold text-slate-400 hover:text-white transition-colors cursor-pointer py-1"
                    >
                      Enquire &rarr;
                    </button>
                  </div>
