...
export const Footer: React.FC<FooterProps> = ({ onNavigate, onSelectServiceForContact }) => {
  const quickLinks = [
    ...
    { name: 'ROI Calculator', id: 'calculator' },
  ...
  return (
    <footer id="main-footer" className="bg-[#091C16] border-t border-[#86EFAC]/10 pt-12 sm:pt-16 pb-10 sm:pb-12 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-8 pb-10 sm:pb-12 border-b border-white/10">
          {/* Brand Col */}
          <div className="sm:col-span-2 lg:col-span-4 space-y-3.5 sm:space-y-4">
            ...
            <div className="pt-1 sm:pt-2 flex items-center gap-2.5 sm:gap-3">
              <span
                ...
                className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-white/5 hover:bg-[#22C55E]/20 border border-white/10 hover:border-[#22C55E]/40 flex items-center justify-center text-slate-300 hover:text-[#22C55E] transition-colors cursor-pointer"
              >
              ...
              {quickLinks.map((item) => (
                <li key={item.name}>
                  <button
                    ...
                    className="hover:text-[#22C55E] transition-colors text-left cursor-pointer py-0.5"
                  >
                    {item.name}
                  </button>
                </li>
              ...
              {SERVICES.map((srv) => (
                <li key={srv.id}>
                  <button
                    ...
                    className="text-slate-400 hover:text-[#86EFAC] transition-colors text-left cursor-pointer py-0.5"
                  >
                    {srv.title}
                  </button>
                </li>
          ...
          <div className="sm:col-span-2 lg:col-span-3 space-y-3">
            ...
            <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm">
              <a
                ...
                className="flex items-center gap-2.5 text-slate-300 hover:text-[#22C55E] transition-colors py-0.5"
              >
              ...
              <a
                ...
                className="flex items-center gap-2.5 text-slate-300 hover:text-[#22C55E] transition-colors break-all py-0.5"
              >
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold bg-white/5 hover:bg-[#22C55E] hover:text-[#0F2D23] border border-white/10 transition-all text-white cursor-pointer"
                >
